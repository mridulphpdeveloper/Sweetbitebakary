	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM sbb_employees WHERE national_id='$national_id' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = ($password1);
							$update = mysqli_query($con, "UPDATE sbb_employees SET password='$pass' WHERE national_id='$national_id'");
							if($update){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<a href="index.php" class="btn btn-sm btn-danger"><b>Cancel</b></a>zzzz
					</div>
				</div>
			</form>
		</div>
