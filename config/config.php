...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://localhost/SweetBiteBakary'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'cakes66f14364406c8'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'cakes66f14364406c8@ssl'); // your store password.
}
