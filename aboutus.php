...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO sbb_contactusquery (name, EmailId, ContactNumber, Message, PostingDate, status) 
...
<?php include('includes/menu-bar.php');?>
    ...
    <div class="container my-5" style="background-color: rgba(255, 255, 255, 0.9); border-radius: 15px; padding: 30px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
        <h1 class="text-center" style="color: #6f42c1; font-family: 'Playfair Display', serif; font-weight: bold;">Bakary Owner</h1>
...
<h2 class="my-3" style="color: #6f42c1; font-family: 'Playfair Display', serif;">Welcome to SweetBite Bakary </h2>
<p style="font-size: 1.5rem; color: #555;">Founded in 2025 by Osman Gani Mridul, SweetBite Bakery is more than just a bakery—it's a haven for dessert enthusiasts who seek the perfect harmony of flavor and artistry. With every treat we create, our mission is to spread sweetness and joy. Each bite reflects our dedication to crafting desserts that are not only visually enchanting but also bursting with rich, delectable flavors, promising a memorable experience for every customer./p>

<h2 class="my-3" style="color: #6f42c1; font-family: 'Playfair Display', serif;">Our Mission</h2>
<p style="font-size: 1.5rem; color: #555;">At SweetBite Bakery, we believe that every celebration deserves to be extraordinary, and we are dedicated to making your moments unforgettable. Whether it’s a birthday, wedding, anniversary, or any other milestone, we add a touch of sweetness and elegance to every occasion. Our mission is to elevate these special moments with cakes that are as unique as the events themselves—crafted with love, meticulous attention to detail, and a personal touch.</p>

<h2 class="my-3" style="color: #6f42c1; font-family: 'Playfair Display', serif;">Our Promise</h2>
<p style="font-size: 1.5rem; color: #555;">At SweetBite Bakery, we take pride in using only the finest and freshest ingredients, handpicked to ensure that every cake tastes as amazing as it looks. Our talented bakers and decorators are passionate about bringing your ideas to life—whether you desire a timeless classic or a one-of-a-kind, custom creation. From elegantly intricate wedding cakes to lively and playful birthday cakes, each masterpiece is a blend of exceptional flavor and artistic flair. Our goal is to surpass your expectations, leaving you craving more with every delightful bite.</p>
