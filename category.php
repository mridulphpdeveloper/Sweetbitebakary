...
<head>
    ...
    <meta name="author" content="SweetBite">
    <meta name="keywords" content="Cake Shop, Online Shopping">
    <meta name="robots" content="all">

    <title>Product Category |  SweetBite Bakary</title>
        ...
        <div class="row outer-bottom-sm">
            ...
            <div class="col-md-3 sidebar">
                <div class="side-menu animate-dropdown outer-bottom-xs">
                    <div class="head"><i class="icon fa fa-align-justify fa-fw"></i>Size / Weight</div>
