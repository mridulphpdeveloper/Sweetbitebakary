...
<html lang="en">
	<head>
	    ...
	    <title>SweetBite Bakary | Cake Details</title>
...
<div class="stock-container info-container m-t-10">
                ...
                echo "LARGE";
            } else if($row['subCategory'] == 2) {
                echo "MEDIUM";
            } else if($row['subCategory'] == 3) {
                echo "SMALL";
            } else if($row['subCategory'] == 4) {
                echo "LARGE";
            } else if($row['subCategory'] == 5) {
                echo "MEDIUM";
            } else if($row['subCategory'] == 6) {
                echo "SMALL";
            } else if($row['subCategory'] == 7) {
                echo "LARGE";
            } else if($row['subCategory'] == 8) {
                echo "MEDIUM";
            } else if($row['subCategory'] == 9) {
                echo "SMALL";
            } else if($row['subCategory'] == 10) {
                echo "LARGE";
            }else if($row['subCategory'] == 11) {
                echo "MEDIUM";
            } else if($row['subCategory'] == 12) {
                echo "SMALL";
            }else if($row['subCategory'] == 13) {
                echo "1kg";
            }else if($row['subCategory'] == 14) {
                echo "1.5kg ";
            }else if($row['subCategory'] == 15) {
                echo "2kg";
            }else if($row['subCategory'] == 16) {
                echo "1kg";
            }else if($row['subCategory'] == 17) {
                echo "1.5kg";
            }else if($row['subCategory'] == 18) {
                echo "2lg";
            }
											?></span>
										</div>	
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Taste :</b>  <?php echo htmlentities($rvw['value']);?> Star</div>
